...
function ApplyLogsInner() {
  ...
  useEffect(() => {
    ...
    async function load() {
      setLoading(true);
      try {
        const r = await api.admin.applyLogs({
          page,
        ...
        {active && (() => {
          ...
          return (
            <>
              ...
              {/* Chat-style thread: learner on the right, Farmer Acharya on the left.
              ...
              <div className="space-y-3">
                ...
                {/* Farmer Acharya: next step as its own bubble — labelled subtly on top */}
                {d.nextStep && (
                  <div className="flex justify-start items-end">
                    <Avatar size={24} useImage className="mr-2" />
