...
export default function AskPage() {
  ...
  async function sendMessage(text: string) {
    ...
    // reply so the user can't hear two Farmer Acharya replies at once.
    audioQueueRef.current?.stop();
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col w-full max-w-3xl mx-auto">
        ...
        {renderMessages.length === 0 && (
          <div className="flex flex-col items-center text-center py-10">
            ...
            <p className="text-xs text-muted mt-1">
              {lang === 'bn' ? 'ফার্মার আচার্যকে জিজ্ঞাসা করুন' : lang === 'hi' ? 'फार्मर आचार्य से पूछें' : 'Ask Farmer Acharya anything'}
            </p>
      ...
      <GeminiLiveOverlay
        ...
        lang={lang}
        moduleId={selectedModuleId}
        title={currentModule ? getTitle(currentModule, lang) : t('appName', lang)}
