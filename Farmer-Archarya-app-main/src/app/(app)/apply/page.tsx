...
const prompts = {
  bn: {
    title: 'মাঠে প্রয়োগ',
    subtitle: 'আজ আপনি মাঠে কী কাজ করলেন?',
    instruction: 'ফসল, মাটি, সেচ, পোকা, রোগ বা বাজার নিয়ে আজ কী দেখলেন বা কী সিদ্ধান্ত নিলেন - বলুন, লিখুন বা ছবি দিন।',
    speakBtn: 'বলুন',
    writeBtn: 'লিখুন',
    cameraBtn: 'ছবি',
    speakDesc: 'ভয়েস রেকর্ড',
    writeDesc: 'টাইপ করুন',
    cameraDesc: 'আজকের মাঠের ছবি',
    placeholder: 'আজ মাঠে আমি...',
    placeholderAdd: 'আরও বিস্তারিত যোগ করুন...',
    send: 'পাঠান',
    submitProgress: 'অগ্রগতি জমা দিন',
    cancel: 'বাতিল',
    thinking: 'ফার্মার আচার্য ভাবছে...',
    finalizing: 'ফার্মার আচার্য মূল্যায়ন করছে...',
    speaking: 'ফার্মার আচার্য বলছে...',
    score: 'প্রয়োগ স্কোর',
    feedback: 'ফার্মার আচার্যের মূল্যায়ন',
    nextStep: 'পরবর্তী পদক্ষেপ',
    again: 'নতুন রিপোর্ট',
    listening: 'বলুন... আমি শুনছি',
    stop: 'থামান',
    youReported: 'আপনি যা জানিয়েছেন',
    ...
    emptySend: 'ছবি, ভয়েস বা লেখা যোগ করুন।',
    finishNote: 'সব বলা হয়ে গেলে "অগ্রগতি জমা দিন" চাপুন - ফার্মার আচার্য স্কোর দেবে।',
    examples: [
      'আজ টমেটো গাছে নিচের পাতায় হলুদ দাগ দেখেছি',
      'আজ ধানের জমিতে জল বেশি দাঁড়িয়ে আছে কি না দেখেছি',
      'আজ পাতার ছবি তুলে পোকা বা রোগের লক্ষণ লিখেছি',
    ],
  },
  hi: {
    title: 'खेत में अभ्यास',
    subtitle: 'आज आपने खेत में क्या काम किया?',
    instruction: 'फसल, मिट्टी, सिंचाई, कीट, रोग या बाजार के बारे में आज क्या देखा या क्या फैसला लिया - बोलें, लिखें या फोटो दें।',
    speakBtn: 'बोलें',
    writeBtn: 'लिखें',
    cameraBtn: 'फोटो',
    speakDesc: 'आवाज रिकॉर्ड',
    writeDesc: 'टाइप करें',
    cameraDesc: 'आज के खेत की फोटो',
    placeholder: 'आज खेत में मैंने...',
    placeholderAdd: 'और विवरण जोड़ें...',
    send: 'भेजें',
    submitProgress: 'प्रगति जमा करें',
    cancel: 'रद्द',
    thinking: 'फार्मर आचार्य सोच रहा है...',
    finalizing: 'फार्मर आचार्य मूल्यांकन कर रहा है...',
    speaking: 'फार्मर आचार्य बोल रहा है...',
    score: 'अभ्यास स्कोर',
    feedback: 'फार्मर आचार्य का मूल्यांकन',
    nextStep: 'अगला कदम',
    again: 'नई रिपोर्ट',
    listening: 'बोलें... मैं सुन रहा हूं',
    stop: 'रोकें',
    youReported: 'आपने जो बताया',
    ...
    emptySend: 'तस्वीर, आवाज या टेक्स्ट जोड़ें।',
    finishNote: 'जब सब बता दें, "प्रगति जमा करें" दबाएं - फार्मर आचार्य स्कोर देगा।',
    examples: [
      'आज टमाटर के पौधे की निचली पत्तियों में पीलापन देखा',
      'आज धान के खेत में पानी बहुत देर तक खड़ा तो नहीं है, यह देखा',
      'आज पत्ते की फोटो लेकर कीट या रोग के लक्षण लिखे',
    ],
  },
  en: {
    title: 'Field Application',
    subtitle: 'What did you do in the field today?',
    instruction: 'What crop work you did, what you observed, what problem you saw, or what decision you made - speak, write, or upload a photo.',
    speakBtn: 'Speak',
    writeBtn: 'Write',
    cameraBtn: 'Photo',
    ...
    cancel: 'Cancel',
    thinking: 'Farmer Acharya is thinking...',
    finalizing: 'Farmer Acharya is evaluating...',
    speaking: 'Farmer Acharya is speaking...',
    score: 'Application Score',
    feedback: "Farmer Acharya's Evaluation",
    nextStep: 'Next Step',
    again: 'New report',
    ...
    finishNote: 'When you\'ve said everything, tap "Submit progress" - Farmer Acharya will give a score.',
    examples: [
      'Today I checked my tomato crop and saw yellowing leaves near the lower part of the plant',
      'Today I irrigated the paddy field and checked whether water was standing too long',
      'Today I uploaded a leaf photo and noted the pest symptoms before deciding whether to spray',
    ],
  },
};
...
export default function ApplyPage() {
  ...
  async function playFarmerReply(text: string) {
...
Latest user turn: "${sentText || '(submitted a photo - give a one-sentence observation, no question)'}"`;
  ...
  function handleLiveTurn(turn: { userText: string; modelText: string }) {
    ...
    const parsed: ApplyResult = {
      ...
      nextStep: lang === 'bn' ? 'পরের কথোপকথনে পরের মাঠের পদক্ষেপ জানান।' : lang === 'hi' ? 'अगली बातचीत में अगला खेत का कदम बताएं।' : 'Share the next field step in the next conversation.',
    };
    setResult(parsed);
    setState('result');
    ...
    try {
      ...
      if (!parsed) {
        parsed = {
          ...
          score: 6,
          feedback: reply,
          nextStep: lang === 'bn' ? 'কাল আরও একটু বিস্তারিত বলুন।' : lang === 'hi' ? 'कल और विस्तार से बताएं।' : 'Add more detail tomorrow.',
        };
      }
      ...
      playFarmerReply(`${parsed.summary}. ${parsed.feedback} ${parsed.nextStep}`);
    } catch (err) {
      setState('conversation');
      setError(err instanceof ApiError ? errorCopy(err, lang) : errorCopy(err, lang));
    }
    ...
    return (
      <div className="h-full flex flex-col items-center justify-center text-center px-6 text-muted">
        ...
        <p className="font-serif italic text-[15px] text-ink max-w-xs">
          {lang === 'bn'
            ? 'আজ মাঠের কাজের কথা বলুন - ছবি, ভয়েস বা টেক্সটে।'
            : lang === 'hi'
            ? 'आज के खेत के काम के बारे में बताएं - फोटो, आवाज या टेक्स्ट में।'
            : 'Tell Farmer Acharya what you did in the field today - photo, voice, or text.'}
        </p>
  ...
  return (
    <div className="h-full flex flex-col max-w-md lg:max-w-3xl mx-auto w-full px-4 lg:px-6">
      ...
      <div className="shrink-0 border-t border-line pt-3 pb-3">
        {composerHidden ? (
          // Compact status bar while Farmer Acharya is thinking/speaking. Composer hides.
