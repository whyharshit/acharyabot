    ...
    return (
      <div className="flex flex-col items-center justify-center px-4 py-16 max-w-md mx-auto">
        <button
          type="button"
          onClick={goBack}
          className="self-start mb-8 inline-flex items-center gap-1.5 rounded-full border border-line bg-cream px-3 py-1.5 text-xs font-semibold text-forest hover:bg-sage"
        >
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 lg:px-6 py-5">
      <button
        type="button"
        onClick={goBack}
        className="inline-flex items-center gap-1.5 rounded-full border border-line bg-cream px-3 py-1.5 text-xs font-semibold text-forest hover:bg-sage mb-4"
      >
        <Icon name="arrowL" size={13} />
        Back
      </button>
