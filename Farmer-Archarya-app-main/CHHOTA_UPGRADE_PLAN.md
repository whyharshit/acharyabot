...
**Date:** 2026-04-15
**Decision source:** MahAcharyaJi review
...
**Target:** `github.com/omnidel-ai/abhishek-acharya-app` on `master`.
**Live:** https://abhishek-acharya-app.vercel.app/
...
- **UX impact:** ZERO — same quiz shape. A learner who retakes the quiz within 7 days gets the same questions (today they get new ones — if MahAcharyaJi says the fresh-questions feel is important, skip this).
...
- ❌ Switching from Messages API to Managed Agents (MahAcharyaJi's decision — keeps Chhota simple)
- ❌ Adding sessions, memory tables, or persistent state beyond what exists
- ❌ Adding a Do Tab, TP Dashboard, photo diagnosis, weekly PDF, or any Bada capability (stays in `abhishek-acharya-ccmanaged`)
