        ...
        {active && (() => {
          ...
          return (
            <>
              ...
              {/* Chat-style thread: learner on the right, Vajra Acharya on the left.
              ...
              <div className="space-y-3">
                ...
                {/* Vajra Acharya: next step as its own bubble — labelled subtly on top */}
                {d.nextStep && (
                  <div className="flex justify-start items-end">
                    <Avatar size={24} useImage className="mr-2" />
