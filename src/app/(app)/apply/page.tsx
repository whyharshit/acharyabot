...
const prompts = {
  bn: {
    ...
    cancel: 'বাতিল',
    thinking: 'Vajra Acharya ভাবছে...',
    finalizing: 'Vajra Acharya মূল্যায়ন করছে...',
    speaking: 'Vajra Acharya বলছে...',
    score: 'প্রয়োগ স্কোর',
    feedback: 'Vajra Acharya মূল্যায়ন',
    ...
    finishNote: 'যখন সব বলা হয়ে যাবে, "সম্পূর্ণ জমা দাও" চাপো — Vajra Acharya স্কোর দেবে।',
    examples: [
      ...
      'আজ RD-তে walk-in ক্লায়েন্টকে Electrical Ankita দেখিয়েছি, ছবি তুলে AI render পাঠিয়েছি',
    ],
  },
  hi: {
    ...
    cancel: 'रद्द',
    thinking: 'Vajra Acharya सोच रहा है...',
    finalizing: 'Vajra Acharya मूल्यांकन कर रहा है...',
    speaking: 'Vajra Acharya बोल रहा है...',
    score: 'अभ्यास स्कोर',
    feedback: 'Vajra Acharya मूल्यांकन',
    nextStep: 'अगला क़दम',
    again: 'नई रिपोर्ट',
    ...
    finishNote: 'जब सब बता दो, "पूरी प्रगति जमा करो" दबाओ — Vajra Acharya स्कोर देगा।',
    examples: [
      ...
      'आज RD में walk-in ग्राहक को Electrical Ankita दिखाया, फोटो से AI render बनाकर भेजा',
    ],
  },
  en: {
    ...
    cancel: 'Cancel',
    thinking: 'Vajra Acharya is thinking...',
    finalizing: 'Vajra Acharya is evaluating...',
    speaking: 'Vajra Acharya is speaking...',
    score: 'Application Score',
    feedback: "Vajra Acharya's Evaluation",
    nextStep: 'Next Step',
    again: 'New report',
    ...
    finishNote: 'When you\'ve said everything, tap "Submit progress" — Vajra Acharya will give a score.',
    examples: [
      ...
      'Today I showed a walk-in client at RD the Electrical Ankita app, generated an AI render from their photo',
    ],
  },
};
...
export default function ApplyPage() {
  ...
  async function playElectricianAcharyaReply(text: string) {
...
Latest user turn: "${sentText || '(submitted a photo — give a one-sentence observation, no question)'}"`;
    ...
    try {
      ...
      playElectricianAcharyaReply(reply);
...
Write all four fields in the learner's language.`;
    ...
    try {
      ...
      playElectricianAcharyaReply(`${parsed.summary}. ${parsed.feedback} ${parsed.nextStep}`);
    } catch (err) {
      setState('conversation');
      setError(err instanceof ApiError ? errorCopy(err, lang) : errorCopy(err, lang));
    }
      ...
      <div className="h-full flex flex-col items-center justify-center text-center px-6 text-muted">
        ...
        <p className="font-serif italic text-[15px] text-ink max-w-xs">
          {lang === 'bn'
            ...
            : 'Tell Vajra Acharya what you did today — photo, voice, or text.'}
        </p>
  ...
  return (
    <div className="h-full flex flex-col max-w-md lg:max-w-3xl mx-auto w-full px-4 lg:px-6">
      ...
      <div className="shrink-0 border-t border-line pt-3 pb-3">
        {composerHidden ? (
          // Compact status bar while Vajra Acharya is thinking/speaking. Composer hides.
