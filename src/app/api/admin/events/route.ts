...
export async function GET(req: NextRequest) {
  ...
  let countQ = db.from("vajra_acharya_events").select("*", { count: "exact", head: true });
  let rowsQ = db.from("vajra_acharya_events").select("*").order("created_at", { ascending: false });
