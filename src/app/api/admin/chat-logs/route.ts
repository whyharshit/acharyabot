 ...
 *
 * Groups vajra_acharya_chat_logs by (learner_id, module_id, lang) so each
...
export async function GET(req: NextRequest) {
  ...
  let q = db.from("vajra_acharya_chat_logs").select("*").order("created_at", { ascending: false }).limit(FETCH_CAP);
