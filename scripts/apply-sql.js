...
(async () => {
  ...
  const verify = `SELECT
    (SELECT count(*) FROM arjun_modules) AS modules,
    (SELECT count(*) FROM arjun_sections) AS sections,
    (SELECT count(*) FROM arjun_content) AS content_rows,
    (SELECT count(*) FROM arjun_videos) AS videos;`;
