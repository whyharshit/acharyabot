// Arjun Acharya — seed generator
// Reads the canonical playbook + hand-crafted trilingual spine modules
// Emits supabase/seed-arjun-content.sql
//
// Usage: node scripts/generate-arjun-seed.js
//
// v1 approach:
...
const MODULES = [
  { id: 'M00-welcome',           icon: '🙏', group_key: 'foundation',
    title: { en: 'Welcome from MahAcharyaJi',          bn: 'MahAcharyaJi-র তরফে স্বাগতম',           hi: 'MahAcharyaJi की ओर से स्वागत' },
  ...
  { id: 'M05-pricing-playbook',  icon: '💰', group_key: 'sales',
    title: { en: 'Pricing Playbook',                    bn: 'মূল্য নির্ধারণ প্লেবুক',                  hi: 'प्राइसिंग प्लेबुक' },
    group_label: { en: 'Sales', bn: 'বিক্রয়', hi: 'सेल्स' } },
  { id: 'M06-vatika-ai',         icon: '🤖', group_key: 'sales',
    title: { en: 'Vatika.AI',                           bn: 'Vatika.AI',                              hi: 'Vatika.AI' } },
  { id: 'M07-proposal-writing',  icon: '📝', group_key: 'sales',
    title: { en: 'Proposal Writing',                    bn: 'প্রস্তাব লেখা',                          hi: 'प्रस्ताव लिखना' } },
  { id: 'M08-sales-cycle',       icon: '🔁', group_key: 'sales',
    title: { en: 'The Sales Cycle',                     bn: 'বিক্রয় চক্র',                            hi: 'सेल्स साइकल' } },
  { id: 'M09-case-studies',      icon: '📚', group_key: 'sales',
  ...
  { id: 'M14-objection-handling',icon: '🛡️', group_key: 'sales',
  ...
  { id: 'M18-pitch-sequence',    icon: '🎯', group_key: 'sales',
    title: { en: 'The Pitch Sequence — 6 Steps',        bn: 'পিচ সিকোয়েন্স — ৬ ধাপ',                 hi: 'पिच सीक्वेंस — 6 कदम' } },
  { id: 'M19-meeting-playbook',  icon: '💼', group_key: 'sales',
...
const M00_SECTIONS = [
  {
    title: { en: 'Welcome to the Vatika Family', bn: 'Vatika পরিবারে স্বাগতম', hi: 'Vatika परिवार में स्वागत' },
    content: {
      en: `Welcome to the KarmYog Vatika Sales & Service team. You are joining a thirty-year practice — not a job, not a company, a practice. MahAcharyaJi has recorded a short welcome for you, which will appear here soon. Until then, this trainer — Arjun — will walk you through everything you need to know to start selling Vatikas and serving our clients.\n\nA Vatika is not a garden we install. It is a sanctuary the neighbourhood comes together to learn, grow, and live better. Your job is to sell that sanctuary, then serve it every month.`,
      bn: `KarmYog Vatika বিক্রয় ও পরিষেবা দলে স্বাগতম। তুমি একটি চাকরি নয়, একটি কোম্পানি নয় — একটি তিন দশকের অনুশীলনে যোগ দিচ্ছো। MahAcharyaJi তোমার জন্য একটি সংক্ষিপ্ত স্বাগত বার্তা রেকর্ড করবেন, যা শীঘ্রই এখানে দেখা যাবে। ততক্ষণ পর্যন্ত, তোমার প্রশিক্ষক অর্জুন তোমাকে Vatika বিক্রি করতে এবং আমাদের ক্লায়েন্টদের পরিষেবা দিতে যা যা জানা দরকার, সবকিছু বলবে।\n\nVatika আমরা যে বাগান বানাই, সেটা নয়। এটা একটি অভয়ারণ্য যেখানে প্রতিবেশীরা একসাথে শেখে, বাড়ে এবং ভালোভাবে বাঁচে। তোমার কাজ হলো সেই অভয়ারণ্য বিক্রি করা, তারপর প্রতি মাসে পরিষেবা দেওয়া।`,
      hi: `KarmYog Vatika सेल्स और सर्विस टीम में स्वागत है। तुम नौकरी में नहीं, कंपनी में नहीं — तीस साल के एक अभ्यास में जुड़ रहे हो। MahAcharyaJi जल्द ही तुम्हारे लिए एक छोटा स्वागत संदेश रिकॉर्ड करेंगे, जो यहाँ दिखेगा। तब तक अर्जुन — तुम्हारा ट्रेनर — तुम्हें Vatika बेचने और हमारे ग्राहकों की सेवा करने के लिए सब कुछ समझाएगा।\n\nVatika वह बाग़ नहीं जो हम लगाते हैं। यह वह पवित्र स्थान है जहाँ पड़ोसी मिलकर सीखते, बढ़ते और बेहतर जीते हैं। तुम्हारा काम है वह स्थान बेचना, फिर हर महीने उसकी सेवा करना।`,
    },
  },
  {
    title: { en: 'Video from MahAcharyaJi (coming soon)', bn: 'MahAcharyaJi-র ভিডিও (শীঘ্রই আসছে)', hi: 'MahAcharyaJi का वीडियो (जल्द आएगा)' },
    content: {
      en: `MahAcharyaJi will record a dedicated welcome video explaining our 3-month North Star, what it means to be part of KarmYog, and how you should think about your role as a Sales & Service team member. Until it is recorded, watch the 5 KarmYog Vatika orientation videos in M15 — Video Library.`,
      bn: `MahAcharyaJi একটি বিশেষ স্বাগত ভিডিও রেকর্ড করবেন যেখানে তিনি আমাদের ৩ মাসের উত্তরলক্ষ্য, KarmYog-এর অংশ হওয়া মানে কী, এবং একজন বিক্রয় ও পরিষেবা সদস্য হিসেবে তোমার ভূমিকা সম্পর্কে বলবেন। যতক্ষণ তা রেকর্ড না হয়, M15-এ ৫টি KarmYog Vatika ওরিয়েন্টেশন ভিডিও দেখো।`,
      hi: `MahAcharyaJi एक खास स्वागत वीडियो रिकॉर्ड करेंगे जिसमें वे हमारे 3-महीने के लक्ष्य, KarmYog का हिस्सा होने का क्या अर्थ है, और सेल्स और सर्विस टीम के सदस्य के रूप में तुम्हारी भूमिका के बारे में बताएँगे। जब तक वह रिकॉर्ड नहीं होता, M15 वीडियो लाइब्रेरी में पाँच KarmYog Vatika ओरिएंटेशन वीडियो देखो।`,
    },
  },
];
...
const M01_SECTIONS = [
  ...
  },
  {
    ...
    content: {
      en: `10 one-time project bookings at Anugrahita-scale or Jhunjhunwala-scale. Could be for a commercial client adding a biophilic feature on top of maintenance, could be a residential project like a duplex install, could be a new Vatika opening.\n\nAverage ticket: ₹5 lakh. (Range ₹79K Sourabh Thakur → ₹8L Jhunjhunwala. Arc of ₹5 lakh is what we book for typical sizable residential or commercial projects.)\n\n10 projects × ₹5 lakh = ₹50 lakh in bookings over 3 months.`,
      bn: `১০টি এককালীন প্রকল্প বুকিং, অনুগৃহীতা-স্কেল বা ঝুনঝুনওয়ালা-স্কেল। বাণিজ্যিক ক্লায়েন্ট রক্ষণাবেক্ষণের উপরে বায়োফিলিক ফিচার যোগ করতে পারে, আবাসিক duplex ইনস্টল বা একটি নতুন Vatika খোলা।\n\nগড় টিকিট: ₹৫ লাখ। (পরিসীমা ₹৭৯K Sourabh Thakur → ₹৮L Jhunjhunwala। গড় আমাদের সাধারণ আবাসিক/বাণিজ্যিক প্রকল্পের জন্য ₹৫ লাখ।)\n\n১০ প্রকল্প × ₹৫ লাখ = ৩ মাসে ₹৫০ লাখ বুকিং।`,
      hi: `10 एकमुश्त प्रोजेक्ट बुकिंग, अनुगृहिता-स्केल या झुनझुनवाला-स्केल। व्यावसायिक ग्राहक रखरखाव के ऊपर बायोफिलिक फ़ीचर जोड़ सकता है, आवासीय duplex इंस्टॉल, या नई Vatika खोलना।\n\nऔसत टिकट: ₹5 लाख। (रेंज ₹79K Sourabh Thakur → ₹8L Jhunjhunwala। हमारे सामान्य आवासीय/व्यावसायिक प्रोजेक्ट के लिए औसत ₹5 लाख।)\n\n10 प्रोजेक्ट × ₹5 लाख = 3 महीनों में ₹50 लाख बुकिंग।`,
    },
  },
  {
    title: { en: '4 — ₹25,000/day daily sales (retail walk-ins from C2 + RD + DM)', bn: '৪ — দৈনিক ₹২৫,০০০ খুচরা বিক্রি (C2 + RD + DM)', hi: '4 — रोज़ ₹25,000 रिटेल बिक्री (C2 + RD + DM)' },
    content: {
      en: `Daily retail walk-in sales from our three retail Vatikas. ₹25,000 per day average.\n\nC2 = Cascade 2 Uniworld Vatika.\nRD = Rosedale Vatika.\nDM = Downtown Mall Vatika (new).\nNV = Hazaratullah Nursery — backend feed only, NOT direct revenue. NV supplies plants to the three retail Vatikas.\n\n₹25,000/day × 30 = ₹7.5 lakh/month = ₹22.5 lakh in 3 months.\n\nFor these to hit target, each retail Vatika needs three things — adequate inventory, trained sales staff, and the systems + collaterals to empower them.`,
      bn: `আমাদের তিনটি রিটেল Vatika-র দৈনিক খুচরা walk-in বিক্রি। গড়ে দিনে ₹২৫,০০০।\n\nC2 = Cascade 2 Uniworld Vatika।\nRD = Rosedale Vatika।\nDM = Downtown Mall Vatika (নতুন)।\nNV = Hazaratullah Nursery — শুধু ব্যাকএন্ড সরবরাহ, সরাসরি রাজস্ব নয়।\n\n₹২৫,০০০/দিন × ৩০ = ₹৭.৫ লাখ/মাস = ৩ মাসে ₹২২.৫ লাখ।\n\nলক্ষ্য পূরণের জন্য, প্রতিটি রিটেল Vatika-র তিনটি জিনিস লাগবে — পর্যাপ্ত ইনভেন্টরি, প্রশিক্ষিত সেলস স্টাফ, এবং তাদের ক্ষমতায়নের সিস্টেম + কোল্যাটেরাল।`,
      hi: `हमारी तीन रिटेल Vatika-s की रोज़ की walk-in रिटेल बिक्री। औसत ₹25,000 रोज़।\n\nC2 = Cascade 2 Uniworld Vatika।\nRD = Rosedale Vatika।\nDM = Downtown Mall Vatika (नई)।\nNV = Hazaratullah Nursery — केवल बैकएंड फ़ीड, सीधी आय नहीं।\n\n₹25,000/दिन × 30 = ₹7.5 लाख/माह = 3 महीनों में ₹22.5 लाख।\n\nलक्ष्य हिट करने के लिए, हर रिटेल Vatika को तीन चीज़ें चाहिए — पर्याप्त इन्वेंटरी, प्रशिक्षित सेल्स स्टाफ, और उन्हें सशक्त करने के सिस्टम + कोलैटरल।`,
    },
  },
];
...
const M_CONTENT = {
  ...
  'M04-club-ecosystem': [
    ...
    { title: { en: 'Adopt-a-Garden + GreenTelligence (Q.Rius + OmniDEL)', bn: 'Adopt-a-Garden + GreenTelligence', hi: 'Adopt-a-Garden + GreenTelligence' },
      content: PLACEHOLDER('en', `Adopt-a-Garden: KarmYog identifies unused spaces (rooftops, terraces, parks), runs fully-managed kitchen gardens, members sponsor seasonally, harvest-share. Pitch this at Month 3 of maintenance contracts — adds ₹25K–₹75K/season.\n\nGreenTelligence: Q.Rius smart stickers + OmniDEL app. Point phone at planter → ML identifies plant + question + guide → fetches curated answer. Plants become digital libraries.\n\nPlant Library: retail counter inside every Vatika (plants ₹150–800, Green Gifts, reference).\nBehtar Life Academy: tech-enabled learning inside the Vatika. Funded by donations + product revenue, NOT course fees.`) },
  ],
  ...
  'M06-vatika-ai': [
    { title: { en: 'Three products, one platform', bn: 'তিনটি পণ্য, একটি প্ল্যাটফর্ম', hi: 'तीन प्रोडक्ट, एक प्लेटफ़ॉर्म' },
      content: PLACEHOLDER('en', `Vatika Studio (vatika-studio.vercel.app) — full AI design platform. Upload photo → pick budget → AI render with real products → quotation → WhatsApp order.\nVatika Ankita (vatika-ankita.vercel.app) — client-facing visualiser for Meta ad traffic, Kolkata-first.\nVatika Ankit (planned) — next iteration.\n\nStack: Next.js 16 + Gemini 2.0 Flash + Replicate Flux fallback + Supabase. 61 planters (15 KarmYog + 46 Ugaoo), 13 plant species, 3 budget tiers.`) },
  ...
  'M12-behtar-life-shop': [
    ...
    { title: { en: 'The sales move inside Behtar Life Shop', bn: 'দোকানে বিক্রয়ের কৌশল', hi: 'दुकान में सेल्स की चाल' },
      content: PLACEHOLDER('en', `Every walk-in is a multi-product conversation:\nEntry via plant or gift → upsell to module → nudge to membership → capture for Adopt-a-Garden.\nA single family visit can touch ₹500 retail + ₹25,000 module + ₹5,000 annual membership = the Vatika compounding at scale.`) },
  ],
  ...
  'M17-faq': [
    { title: { en: 'Q1. What does KarmYog Vatika do?', bn: 'প্র১: KarmYog Vatika কী করে?', hi: 'सवाल 1: KarmYog Vatika क्या करती है?' },
      content: PLACEHOLDER('en', `We create biophilic living sanctuaries — modular gardens, green walls, planters, plants, complete installations — for homes, offices, institutions. We run the Vatika as a club with membership tiers, a retail counter (Behtar Life Shop), an Academy, and a smart-planter GreenTelligence layer. We also maintain installations monthly.`) },
  ...
  'M20-first-week': [
    { title: { en: 'Your first 7 days at KarmYog Vatika', bn: 'KarmYog Vatika-র প্রথম ৭ দিন', hi: 'KarmYog Vatika के पहले 7 दिन' },
...
// ============================================================
// VIDEOS — 5 KarmYog Vatika explainers (all mapped to M15)
// ============================================================
const VIDEOS = [
  { youtube_id: '6s7zI_W0sko',      module_id: 'M15-video-library', start_seconds: 0,
    title: { en: 'KarmYog Vatika Explainer 1', bn: 'KarmYog Vatika ব্যাখ্যা ১', hi: 'KarmYog Vatika परिचय 1' } },
  { youtube_id: 'VVheqkr97wI',      module_id: 'M15-video-library', start_seconds: 0,
    title: { en: 'KarmYog Vatika Explainer 2', bn: 'KarmYog Vatika ব্যাখ্যা ২', hi: 'KarmYog Vatika परिचय 2' } },
  { youtube_id: '-NHfMxGTd1c',      module_id: 'M15-video-library', start_seconds: 324,
    title: { en: 'KarmYog Vatika Explainer 3 (starts 5:24)', bn: 'KarmYog Vatika ব্যাখ্যা ৩ (৫:২৪ থেকে)', hi: 'KarmYog Vatika परिचय 3 (5:24 से)' } },
  { youtube_id: 'R4JtntEFOjY',      module_id: 'M15-video-library', start_seconds: 0,
    title: { en: 'KarmYog Vatika Explainer 4', bn: 'KarmYog Vatika ব্যাখ্যা ৪', hi: 'KarmYog Vatika परिचय 4' } },
  { youtube_id: 'YfX-aeVlKLA',      module_id: 'M15-video-library', start_seconds: 28,
    title: { en: 'KarmYog Vatika Explainer 5 (starts 0:28)', bn: 'KarmYog Vatika ব্যাখ্যা ৫ (০:২৮ থেকে)', hi: 'KarmYog Vatika परिचय 5 (0:28 से)' } },
...
function emit() {
  const lines = [];
  lines.push('-- Arjun Acharya v1 — seed content (generated)');
  lines.push('-- Regenerate: node scripts/generate-arjun-seed.js');
  lines.push(`-- Generated: ${new Date().toISOString()}`);
  lines.push('');
  lines.push('-- Idempotent: wipe before seeding');
  lines.push('TRUNCATE arjun_videos, arjun_content, arjun_sections, arjun_modules CASCADE;');
  lines.push('');
  ...
  MODULES.forEach((m, i) => {
    ...
    lines.push(`INSERT INTO arjun_modules (id, title_bn, title_hi, title_en, icon, sort_order, group_key, group_label_bn, group_label_hi, group_label_en) VALUES (${q(m.id)}, ${q(m.title.bn)}, ${q(m.title.hi)}, ${q(m.title.en)}, ${q(m.icon)}, ${i}, ${q(m.group_key)}, ${q(gl.bn)}, ${q(gl.hi)}, ${q(gl.en)});`);
  });
  lines.push('');
  ...
  MODULES.forEach(m => {
    if (!byModule[m.id]) {
      byModule[m.id] = [{
        ...
        content: PLACEHOLDER('en', `Content for this module is being drafted. Check back shortly, or ask Arjun directly on the Ask tab.`),
      }];
    }
  });
  ...
  MODULES.forEach(m => {
    ...
    secs.forEach((s, si) => {
      lines.push(`  INSERT INTO arjun_sections (module_id, title_bn, title_hi, title_en, sort_order) VALUES (${q(m.id)}, ${q(s.title.bn)}, ${q(s.title.hi)}, ${q(s.title.en)}, ${si}) RETURNING id INTO sec_id;`);
      // content per lang
      ['bn','hi','en'].forEach(lang => {
        const body = s.content[lang] ?? '';
        const status = (lang === 'en') ? 'published' : (body.startsWith('[') ? 'review' : 'published');
        lines.push(`  INSERT INTO arjun_content (section_id, lang, body, status) VALUES (sec_id, ${q(lang)}, ${q(body)}, ${q(status)});`);
      });
    });
  });
  lines.push('END $$;');
  ...
  lines.push('-- VIDEOS');
  VIDEOS.forEach((v, i) => {
    lines.push(`INSERT INTO arjun_videos (youtube_id, module_id, title_bn, title_hi, title_en, start_seconds, sort_order) VALUES (${q(v.youtube_id)}, ${q(v.module_id)}, ${q(v.title.bn)}, ${q(v.title.hi)}, ${q(v.title.en)}, ${v.start_seconds}, ${i});`);
  });
  lines.push('');
...
// RUN
// ============================================================
const outPath = path.join(__dirname, '..', 'supabase', 'seed-arjun-content.sql');
